...
<body>
    <div id="wrapper">
        ...
        <div id="contentwrap">
			<div id="content">
				<img class="float" src="../images/air-quality-egg1.jpg" width=260 height=192 alt="Logo">
				...
				Zusätzlich bietet SkyEagle einen Sensor Observation Service (SOS) an. Über diesen lassen sich die gemessenen Daten als XML-Dateien abfragen.
			</div>
		</div>
	</div>
</div>
