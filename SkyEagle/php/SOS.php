...
<body>
    <div id="wrapper">
        ...
        <div id="contentwrap">
			<div id="content">
			SOS steht für Sensore Observation Service und ermöglicht es, mit HTTP-Anfragen gemessene Daten in XML-Form zu erhalten.<br><br>
			SkyEagle bietet einen solchen im Core Profile und stellt somit folgenden Operationen bereit:<br><br>
